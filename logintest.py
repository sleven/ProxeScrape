...
request = urllib2.Request(
    "http://www.proxyfire.net/forum/login.php")
...
original_text = form["vb_login_username"]  # a string, NOT a Control instance
...
original_text = form["vb_login_password"]  # a string, NOT a Control instance
form["vb_login_password"] = "rcsck7x890"
...
#control = form.find_control("vb_login_username=User Name")
...
#control = form.find_control("vb_login_password=", type="text")
#print control.name, control.value, control.type
#control.value = ["rcsck7x890"]
...
#control = form.find_control("vb_login_password=")
